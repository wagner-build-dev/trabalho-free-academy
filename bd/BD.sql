...
--
-- Host: 127.0.0.1
-- Tempo de geração: 10/06/2026 às 17:35
...
CREATE TABLE `produtos` (
  ...
  `estoque` int(11) DEFAULT 999,
  `arquivo_curso` varchar(255) DEFAULT NULL,
  `criado_em` datetime DEFAULT current_timestamp(),
  `image_url` varchar(500) DEFAULT NULL,
  `course_file` varchar(500) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
('root', '[{\"db\":\"comercio_eletronico\",\"table\":\"clientes\"}]');
...
('root', '2026-06-10 15:34:51', '{\"Console\\/Mode\":\"collapse\",\"lang\":\"pt_BR\"}');
